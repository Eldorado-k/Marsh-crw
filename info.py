...
BOT_TOKEN = environ.get('BOT_TOKEN', "7783135016:AAFl5W8HArtshQTKaMx0rklHFKa6doA4vJU")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://iili.io/FTgieQp.md.jpg https://iili.io/FTgZCc7.md.jpg https://iili.io/FTgt6hJ.md.jpg https://iili.io/FTgppcl.md.jpg https://iili.io/FTrH34j.md.jpg https://iili.io/FTr2GMF.md.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7428552084').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '7428552084').split()]  # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002463797892').split()]  # For Multiple Id Use One Space Between Each.
...
reqst_channel = environ.get('REQST_CHANNEL', '-1002376378205')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002165407793')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Ethan:Ethan123@telegrambots.lva9j.mongodb.net/?retryWrites=true&w=majority&appName=TELEGRAMBOTS")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://iili.io/FRNMu0Q.md.jpg') # payment code picture url.
PAYMENT_TEXT = environ.get('PAYMENT_TEXT', '<b>- PLANS DISPONIBLES - \n\n- 700FCFA - 1 SEMAINE\n- 2000FCFA - 1 MOIS\n- 3000FCFA - 3 MOIS\n- 5000FCFA - 6 MOIS\n\n🎁 FONCTIONNALITÉS PREMIUM 🎁\n\n○ AUCUNE VÉRIFICATION NÉCESSAIRE\n○ PAS DE LIENS À OUVIR\n○ FICHIERS DIRECTS\n○ SANS PUBLICITÉ\n○ LIENS DE TÉLÉCHARGEMENT ULTRA-RAPIDES\n○ LIENS DE STREAMING MULTI-JOUEURS\n○ FILMS & SÉRIES ILLIMITÉS\n○ SUPPORT ADMIN COMPLET\n○ DEMANDES TRAITÉES SOUS [1H] SI DISPONIBLE\n\n✨ MOYEN DE PAIEMENT - <code>Tous Les Modes de Paiements sont accepté</code>\n\nCLIQUEZ POUR VÉRIFIER VOTRE PLAN /myplan\n\n💢 ENVOYEZ LA PREUVE DE PAIEMENT\n\n‼️ MERCI DE PATIENTER APRÈS ENVOI POUR ACTIVATION</b>')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/BotZFlixSupport')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/BotZFlix')
...
VERIFY_SHORTLINK_URL = environ.get('VERIFY_SHORTLINK_URL', 'linkmonetizer.in')
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '81ad80c93ed7f15c4e7543a8e91eacaab255c666')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/BotZFlix/217') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
...
MSG_ALRT = environ.get('MSG_ALRT', 'Créé Par @Kingcey ❤️')
...
LANGUAGES = ["français", "anglais", "vostfr"]
SEASONS = ["season 1", "season 2", "season 3", "season 4", "season 5", "season 6", "season 7", "season 8", "season 9", "season 10"]
EPISODES = ["E01", "E02", "E03", "E04", "E05", "E06", "E07", "E08", "E09", "E10", "E11", "E12", "E13", "E14", "E15", "E16", "E17", "E18", "E19", "E20", "E21", "E22", "E23", "E24", "E25", "E26", "E27", "E28", "E29", "E30", "E31", "E32", "E33", "E34", "E35", "E36", "E37", "E38", "E39", "E40"]
QUALITIES = ["360p", "480p", "720p", "1080p", "1440p", "2160p", "HDRip", "WebRip", "4K"]
